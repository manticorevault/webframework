...
function () {
  ...
  UserForm.prototype.render = function () {
    ...
    this.parent.innerHTML = ''; // Re-render the template

    var templateElement = document.createElement('template');
    templateElement.innerHTML = this.template(); // Bind the events

    this.bindEvents(templateElement.content); // Stick the events to the parent element
